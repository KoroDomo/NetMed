    ...
    public class UnitTestDoctorsServ
    {
        ...
        public async Task GetAllDataReturnAllDoctorsData()
        {
            ...
            var doctors = new List<Doctors>
                {
                    new Doctors { Id = 1, SpecialtyID = 1, LicenseNumber = "12345", PhoneNumber = "1234567890", YearsOfExperience = 5, Education = "Medical School", Bio = "Experienced doctor", ConsultationFee = 100, ClinicAddress = "123 Clinic St", LicenseExpirationDate = DateOnly.FromDateTime(DateTime.Now.AddYears(1)), AvailabilityModeId = 1 },
                    new Doctors { Id = 2, SpecialtyID = 2, LicenseNumber = "67890", PhoneNumber = "0987654321", YearsOfExperience = 10, Education = "Another Medical School", Bio = "Highly experienced doctor", ConsultationFee = 200, ClinicAddress = "456 Clinic St", LicenseExpirationDate = DateOnly.FromDateTime(DateTime.Now.AddYears(2)), AvailabilityModeId = 2 }
                };
        ...
        //    {
        //        Success = true,
        //        data = new Doctors { Id = 1, SpecialtyID = 1, LicenseNumber = "12345", PhoneNumber = "1234567890", YearsOfExperience = 5, Education = "Medical School", Bio = "Experienced doctor", ConsultationFee = 100, ClinicAddress = "123 Clinic St", LicenseExpirationDate = DateOnly.FromDateTime(DateTime.Now.AddYears(1)), AvailabilityModeId = 1 }
        //    };
        ...
        public async Task AddDoctorReturnDoctorAdded()
        {
            ...
            //{
            //    Success = true,
            //    data = new Doctors { Id = 9, SpecialtyID = 2, LicenseNumber = "59343", PhoneNumber = "849222013", YearsOfExperience = 2, Education = "UCE", Bio = "Recommended Doctor", ConsultationFee = 400, ClinicAddress = "Santo Domingo", LicenseExpirationDate = DateOnly.FromDateTime(DateTime.Now.AddYears(1)), AvailabilityModeId = 1 }
            //};
